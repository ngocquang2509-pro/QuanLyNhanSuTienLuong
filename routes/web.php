...
Route::get('/record', [App\Http\Controllers\AccountingController::class, 'record'])->name('Accounting.record');
Route::get('/luong/{id}', [App\Http\Controllers\AccountingController::class, 'show'])->name('luong.show');
